...
function moveCircle(circle){
    circle.x += circle.speedX;   //TODO 4 there was no +, the circle was set to its speed 
...
function bounceCircle(circle){
    ...
    // this bounces off the bottom wall
        ...
        circle.y -= circle.speedY;
        circle.speedY *= -1;  //todo 5 this was speedX
    }
}

// this redraws the circle's position on the screen
function updateCircleOnScreen(circle){
    maxCircles = 10;  //TODO 3: THIS WAS SET TO 0 WHICH CAUSED THE LOOP IN LINE 92 TO NOT WORK
